...
|GC类别  | JVM堆大小  | Minor GC次数 | Major GC次数| Full GC次数 | 是否OOM  | 生成对象数 |
|------ | ----      | ----         | ----       | ----       |----     |----  |  
|串行    |128m       |7            |1           |21            |是       | -    |
|串行    |512m       |10           |7           |1             |否       | 9372 |
|串行    |1g         |9            |0           |0             |否       | 9678 |
|串行    |4g         |2            |0           |0             |否       | 8355 |
|并行    |128m       |9            |0           |14            |是       | -    |
|并行    |512m       |34           |0           |7             |否       | 9463 |
|并行    |1g         |17           |0           |1             |否       |10731 |
|并行    |4g         |2            |0           |0             |否       | 7867 |
|CMS    |128m       |7            |7           |11            |是       | -    |
|CMS    |512m       |12           |8           |0             |否       | 9636 |
|CMS    |1g         |10           |2           |0             |否       |11417 |
|CMS    |4g         |5            |0           |0             |否       |11240 |
|G1     |128m       |35           |7           |9             |是       | -    |
|G1     |512m       |67           |37          |3             |否       |11126 |
|G1     |1g         |29           |0           |0             |否       |13448 |
|G1     |4g         |14           |0           |0             |否       |13392 |
